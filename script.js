...
if (length < 8 || length > 128) {
  alert( "Your password must have at least 8 characters, but no more than 128 characters. Please try again."); return;
...
if (options.containsAlpha) {
  ...
  includedCharacters.push(getRandom(alpha));
}
...
if (options.containsSpecCharacter) {
  ...
  includedCharacters.push(getRandom(specCharacter));
}
